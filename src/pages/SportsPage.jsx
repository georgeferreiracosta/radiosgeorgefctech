      ...
      {!isHeaderCollapsed && (
        <div className="bg-gray-800/95 backdrop-blur-md border-b border-gray-700 p-4 flex-shrink-0">
          <div className="container mx-auto">
            <h2 className="text-xl sm:text-2xl text-white font-bold">📰 Notícias</h2>
            <p className="text-gray-300 mt-2 text-sm sm:text-base">Mantenha-se informado com as últimas notícias.</p>
          </div>
        </div>
      )}
      ...
      {isHeaderCollapsed && (
        <div className="sticky top-0 z-10 bg-gray-900/90 backdrop-blur border-b border-gray-800 px-4 sm:px-6 py-2">
          <div className="container mx-auto flex items-center justify-between">
            <span className="text-white text-sm font-semibold">📰 Notícias</span>
      ...
      <div onScroll={onScroll} className="flex-1 overflow-y-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
        <div className="container mx-auto">
          <div className="bg-gray-800 rounded-lg p-6">
            <p className="text-gray-300">News content coming soon...</p>
          </div>
        </div>
      </div>
    </div>
